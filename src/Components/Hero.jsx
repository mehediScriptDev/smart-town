  ...
  return (
    <section>
      <div className=" bg-mainbg">
        ...
        <div id="explore" className="box col-span-6 bg-mainbg">
          <div className="md:w-10/12 mx-auto md:border-4 md:border-mainbg">
          <Carousel useKeyboardArrows={true}>
            {images.map((URL, index) => (
              <div className="slide border-mainbg border-2">
                <img className="min-h-min" alt="sample_file" src={URL} key={index} />
              </div>
            ))}
          </Carousel>
          </div>
