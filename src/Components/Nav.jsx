      ...
      <div className="w-10/12 mx-auto *:text-white">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <a className="join text-2xl md:text-3xl flex items-center"><span className="font-alfa font-semibold join-item">
             
              Smart</span><span className="join-item font-italy text-btncl">Town</span></a>
          </div>
          ...
          <a className="btn btn-ghost hover:bg-mainbg hover:text-white hover:border-transparent hidden md:flex">Emergency</a>
